...
def prepopulate_plants(db: Session):
    if db.query(models.Plant).count() == 0:
        ...
        plants = [
            models.Plant(name="Aptar Annecy", description=france, address="19 Avenue des Vieux Moulins 74000 Annecy,France", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Charleval", description=france, address="La Vente Cartier - RD 149 - route de Vascoeuil 27380 Charleval, Normandie France", plantConfidence=0.75),
            models.Plant(name="Aptar Chavanod - Reboul", description=france, address="31 rue Polaris 74650 Chavanod, Auvergne-Rhône-Alpes France", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Granville", description=france, address="123 Rue du Conillot 50400 Granville, Normandie France", plantConfidence=0.75),
            models.Plant(name="Aptar Guangzhou", description=china, address="No.98 Fenghuang 8th Road Sino-Singapore Guangzhou Knowledge City Huangpu District Guangzhou, Guangdong 510700, China ", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Le Neubourg", description=france, address="Lieu-Dit Le Prieuré 56 avenue du Doyen Jussiaume 27110 Le Neubourg, Normandie France", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Maringa", description=spain, address="Rua Pioneira Maria Cavalcante Ruy 87065-090 PR Brazil", plantConfidence=0.75),
            models.Plant(name="Aptar Aptar McHenry", description=usa, address="4900 Prime Parkway 60050 McHenry, IL", plantConfidence=0.75),
            models.Plant(name="Aptar Menden", description=germany, address="15-21 Franz-Kissing-Straße 58706 Menden, NRW Germany", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Oyonnax", description=france, address="165 rue des Cherolles 01100 Oyonnax, Auvergne-Rhône-Alpes France", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Poincy", description=france, address="44 Avenue de Meaux 77470 Poincy, IDF France", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Radolfzell", description=germany, address="4 Unter den Reben 78253 Eigeltingen, BW German", plantConfidence=0.75),
            models.Plant(name="Aptar Suzhou", description=china, address="No.2 Dongwang Road, Suzhou, Jiangsu, 215123, China", plantConfidence=0.75),
            models.Plant(name="Aptar Torello", description=spain, address="Calle Gorg Negre 10 Poligono Industrial Puigba 08570 TORELLO, Barcelona, Spain", plantConfidence=0.75),
            ...
            models.Plant(name="Aptar Val-de-Reuil", description=france, address="Route des Falaises 27100 Val-de-Reuil, Normandie France", plantConfidence=0.75),
            models.Plant(name="Aptar Villingen", description=germany, address="36 Auf Herdenen 78052 Villingen-Schwenningen, BW Germany", plantConfidence=0.75),
